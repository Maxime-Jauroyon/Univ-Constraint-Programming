...
minimize 
   ...
   // minimise le nombre total de trous dans les differents parcours
   sum (p in parcoursEdt) parcoursTrous[p.id]; 
...
execute {
    ...
    var modelName = "edt_minTrous"; // Remplacer XXX par le nom spécifique du modèle
